 ...
 */
export function calculateMaxCompletionTokens(sourceLength) {
...
export function createTranslator(options = {}) {
  ...
  const reasoningEffort = getValidReasoningEffort(model, options.reasoningEffort) || 'medium';
  ...
  async function translateChunk(chunk, contextOrLanguage = {}, targetLanguage = null) {
    ...
    const maxCompletionTokens =
      options.maxCompletionTokens !== undefined
        ...
        : calculateMaxCompletionTokens(chunk.length);
